...
public class tugasakhir {
    ...
    public static void d_harga(){
        System.out.println("\n\n                                 APLIKASI KASIR \n");
        System.out.println("+------------------------------------+    +------------------------------------+");
        System.out.println("+        DAFTAR MENU MAKANAN         +    +        DAFTAR MENU MINUMAN         +");
        System.out.println("+-----+----------------+-------------+    +-----+----------------+-------------+");
        System.out.println("| No. |      Menu      |    Harga    |    | No. |      Menu      |    Harga    |");
        System.out.println("+-----+----------------+-------------+    +-----+----------------+-------------+");
        System.out.println("|  1  |  Nasi Goreng   |  Rp. 13000  |    |  5  |  Jus Jambu     |  Rp. 7000   |");
        System.out.println("|  2  |  Mie Ayam      |  Rp. 15000  |    |  6  |  Jus Jeruk     |  Rp. 5000   |");
        System.out.println("|  3  |  Nasi Bakar    |  Rp. 18000  |    |  7  |  Air Mineral   |  Rp. 3000   |");
        System.out.println("|  4  |  Sop Kambing   |  Rp. 25000  |    |  8  |  Teh Manis     |  Rp. 2000   |");
        System.out.println("+-----+----------------+-------------+    +-----+----------------+-------------+\n");
    }
